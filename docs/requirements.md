...
IdeaTubeは、YouTuberと視聴者をつなぐプラットフォームです。視聴者がYouTube企画のアイデアを投稿し、コミュニティがそれを評価することで、クリエイターが本当に求められているコンテンツを把握できるようにします。さらに、チャンネルオーナーが魅力的な企画アイデアを発見した際には、企画詳細ページから直接クラウドファンディングを開始し、視聴者からの資金的な支援を得て企画を実現できる仕組みも提供します。また、クラウドファンディングが成功した場合には、企画を考案した投稿者に対して集まった資金の3%が報酬として還元され、運営は11%の手数料（Stripe決済手数料を含む）を受け取る仕組みを備えており、アイデア提案者のモチベーション向上と継続的な企画投稿を促進します。
...
- 管理者による審査プロセス
- 企画者への報酬還元（集まった資金の3%）
- 運営手数料（集まった資金の11%、Stripe決済手数料を含む）
