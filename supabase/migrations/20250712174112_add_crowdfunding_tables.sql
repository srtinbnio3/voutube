...
-- 作成日時: 2025-07-12
-- 更新日時: 2025-01-27 (リワードテーブルフィールド統合)
-- 概要: クラウドファンディング機能に必要なテーブルと関数を追加
-- 統合されたフィールド: delivery_date, requires_shipping, shipping_info, images, template, is_unlimited, requires_contact_info, requires_email, requires_address
...
-- crowdfunding_rewards テーブルのカラムコメント
