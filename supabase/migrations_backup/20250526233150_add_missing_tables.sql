...
alter table "public"."comments" add column "mentioned_username" text;

alter table "public"."comments" alter column "id" set default gen_random_uuid();

alter table "public"."posts" drop column "content";

alter table "public"."posts" add column "channel_id" uuid not null;

alter table "public"."posts" add column "description" text not null;

alter table "public"."posts" add column "score" integer default 0;
